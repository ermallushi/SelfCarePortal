...
Sensitive hosts, internal IP addresses, access keys, passwords, service identifiers and similar environment-specific values should stay out of source control and be supplied through secure configuration.
